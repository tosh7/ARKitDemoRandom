...
namespace UnityEngine.XR.iOS {
	public class UnityARHitTestExample : MonoBehaviour {
		...
		void CreateObj (Vector3 atPosition) {
			number = Random.Range(0, dragons.Length);
			GameObject dragon = Instantiate(dragons[number], atPosition, Quaternion.identity);
			dragon.transform.LookAt(dragons[number].transform);
			dragon.transform.rotation = Quaternion.Euler( 0.0f, dragon.transform.rotation.eulerAngles.y, dragon.transform.rotation.z);
		}
